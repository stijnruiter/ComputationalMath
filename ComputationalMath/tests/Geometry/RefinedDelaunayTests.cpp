...
namespace Geometry
{
    ...
    TEST(RefinedDelaunayTests, Refine_WhenPolygonIsComplex_ShouldResultRefinedDelaunay)
    {
        ...
        EXPECT_EQUIVALENT_USING(mesh.Interior, std::vector<TriangleElement>({TriangleElement(0, 2, 1), TriangleElement(10, 6, 3), TriangleElement(3, 6, 5), TriangleElement(5, 2, 3), TriangleElement(2, 4, 1), TriangleElement(12, 2, 0), TriangleElement(3, 11, 10), TriangleElement(2, 5, 4), TriangleElement(6, 10, 7), TriangleElement(11, 3, 2), TriangleElement(9, 8, 10), TriangleElement(7, 10, 8), TriangleElement(12, 11, 2), TriangleElement(9, 10, 11), TriangleElement(11, 12, 9)}), TestHelper::TriangleElementCyclicalEqual);

        delaunay.Refine(7);
        mesh = delaunay.ToMesh();
        EXPECT_EQ(mesh.Vertices.size(), 19);
        EXPECT_EQUIVALENT_USING(mesh.Interior, std::vector<TriangleElement>({TriangleElement(12, 18, 0), TriangleElement(10, 6, 3), TriangleElement(15, 3, 6), TriangleElement(13, 3, 5), TriangleElement(4, 18, 13), TriangleElement(18, 12, 2), TriangleElement(3, 11, 10), TriangleElement(3, 13, 2), TriangleElement(6, 10, 7), TriangleElement(11, 3, 2), TriangleElement(16, 8, 10), TriangleElement(7, 10, 8), TriangleElement(9, 17, 12), TriangleElement(8, 16, 9), TriangleElement(17, 9, 16), TriangleElement(18, 4, 1), TriangleElement(4, 13, 14), TriangleElement(13, 5, 14), TriangleElement(3, 15, 5), TriangleElement(10, 11, 16), TriangleElement(17, 16, 11), TriangleElement(11, 2, 17), TriangleElement(2, 12, 17), TriangleElement(13, 18, 2), TriangleElement(1, 0, 18)}), TestHelper::TriangleElementCyclicalEqual);
    }
